...
const ModalEditHomework = ({ visible, onHide, getData, idTarea, idCurso }) => {
    ...
    const Homework = {
        nombre,
        descripcion,
        dateDelivery: convertirFormatoFecha(deliveryDate.toString()),
    ...
    const HandleSubmit = async () => {
        ...
        try {
            await axios.put(`http://192.168.3.9:3000/api/homeworks/${idTarea}`, Homework);
            getData()
            onHide()
        } catch (error) {
            console.log(error)
...
export default ModalEditHomework;