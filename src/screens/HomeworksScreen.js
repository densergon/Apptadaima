...
const HomeworksScreen = ({ route }) => {
    ...
    return (
        <ScrollView>
                ...
                <View style={styles.container}>
                    {tareas.map((tarea) => (
                        ...
                        <View key={tarea.idTareas} style={styles.homework} >
                            <Link to={{ screen: 'Tarea', params: { id: tarea.idTareas, curso: id } }}
                                key={tarea.idTareas} style={styles.courseitem}>
            ...
            <ModalAddHomework visible={visible} onHide={() => setVisible(false)} getData={() => fetchTareas()} route={route} />
